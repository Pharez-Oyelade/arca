...
const Services = () => {
  return (
    <section className="bg-[#151717] text-white py-10 md:py-16 lg:py-20">
      ...
      <div className="px-4 md:px-8 lg:px-20 h-[200px] md:h-[280px] lg:h-[320px] rounded-lg relative overflow-hidden group">
        <Image
        ...
        <Link href="/">
          ...
          <div
            className="hidden md:block bg-[#151717] absolute h-full w-full top-0 inset-0 z-10 md:group-hover:-translate-y-full transition-transform duration-500 md:duration-700 ease-in-out will-change-transform"
          ...
          <div className="flex flex-col md:flex-row justify-between gap-4 md:gap-8 lg:gap-40 items-center z-50 text-white relative h-full p-4 md:p-6">
            ...
            <div className="w-full md:w-[40%] text-4xl md:text-6xl lg:text-9xl relative overflow-hidden text-center md:text-left">
              Buy
              <div
                className="absolute w-[50%] bottom-1 h-1 bg-white md:group-hover:translate-x-0 transition-transform duration-500 md:duration-700 ease-in-out opacity-0 md:group-hover:opacity-100 will-change-transform"
